    ...
    <div class="flex-w flex-sb">
        <div class="w-size13 p-t-30 respon5">
            <div class="wrap-slick3 flex-sb flex-w">
                ...
                <div class="slick3">
                    <div class="item-slick3" data-thumb="images/img/{{$coffee->thumbnail}}">
                        <div class="wrap-pic-w">
                            <img src="images/img/{{$coffee->thumbnail}}" alt="IMG-PRODUCT">
                        </div>
                    </div>
                ...
                <div class="flex-r-m flex-w p-t-10">
                    <div class="w-size16 flex-m flex-w">
                        ...
                        <div class="btn-addcart-product-detail size9 trans-0-4 m-t-10 m-b-10">
                            <!-- Button -->
                            <a href="{{route('buyer-getadd',$coffee->id)}}" class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4">
                                Mua ngay
                            </a>
                        </div>
                    </div>
